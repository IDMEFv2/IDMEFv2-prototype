...
PGPASSWORD=changeme psql -d prewikka -h postgres -U postgres -c "UPDATE prewikka_user_configuration SET config = '{\"\": {\"password\": \"\$5\$rounds=535000\$F0fsipTsXZvzOM6n\$r4D77J5PrWT/ZfRx7z0D/44d64irmg5ENnEwvLOASW.\"}}' WHERE userid = '21232f297a57a5a743894a0e4a801fc3';" || :
